    ...
    switch(which) {
        ...
        case SyscallException:
        {
            switch(type) {
                ...
                case SC_ReadString:
                {
                    int buffAddr = machine->ReadRegister(4); // Lay dia chi tham so buffer truyen vao tu thanh ghi so 4
                    int maxLen = machine->ReadRegister(5); // Lay do dai toi da cua chuoi nhap vao tu thanh ghi so 5
                ...
                case SC_PrintString:
                {
                    ...
                    char* buffer = User2System(virtAddr, MaxBuffer);
